...
if($uuid>0)
			  ...
			  {
			echo 	$user_id=$s->value('R_USER_ID');
			  }
...
$insertbid=mysql_query("insert into bid set bidderid='$user_id',job_poster_profile_id='$jpid',jobid='$jobid',category_type='$proid',bids_left='',cost_for_premium='',proposal_status='',bid_details='$biddetails',total_estimated_cost='$totalestimatedcost',attach_files='$attchname',bid_at_cost='$bidcost',agreement='$agreement',bid_date='$dd'");
  ...
  <div class="canten">
	...
	<div class="center_in">
      ...
      <div class="sign_cl">  <h1>Skill Sapien Page Detail </h1>
        ...
        <div class="text-area"><?php echo $bidleft ; ?></div>
            <div class="clear"></div>
          </div>
          <div class="row2">
            <label class="label_cl2">Cost for Premium </label>
        <div class="text-area">    3bid</div>
            <div class="clear"></div>
          </div>
          <div class="row2">
