	...
	if($count > 0){	
     ...
     $s->set('USER_LOGIN',"true");
		...
		$user_id=$db->insert_id(); 
	      $profile_query="INSERT INTO  `profiles` ( `user_id`, `first_name`, `gender`, `birthdate`, `primary_email`, `date`, `status`,`company_details`,`country`,`photo`,`vertical_id`) VALUES ( '".$user_id."', '".$name."','".$gender1."', '".$birthday."',  '".$email."', now(),'".ENABLE."', '', '".$country['countries_id']."', '','".VERTICAL_ID."');"; 
