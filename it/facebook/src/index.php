...
$app_id = "109075260944";
$fb_authorize_url = 'https://graph.facebook.com/oauth/authorize?client_id='. $app_id .'&redirect_uri=http://www.vootar.com/facebook/index.php&scope=user_activities,user_birthday,user_hometown,user_location,email';
...
AND us_email = '". $mails ."'";	
	...
	echo "<script>window.location.href='http://www.vootar.com/registro/registro_usuarios.php'</script>";
	exit();
