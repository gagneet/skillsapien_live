...
Is_valid_uesr();
	...
	accept
	*/
	if($_REQUEST['accept']=="yes")
	{
		if(accept($_REQUEST['cid'],$_REQUEST['jid']))
		{
		 header("location:accept-thanks.php");
		}
	}
	/*
	add reply
	*/
	if($_REQUEST['data']=="data")
	{
		...
		{
			$file=sprintf("%-010s",$s->value('R_USER_ID'))."_JID_".$_REQUEST['jid']."_".time().".".get_extension($_FILES['file']['name']);
    ...
    <div class="center_in">
      ...
      <h1>Counter-offer or accept Skill Profiles for interview
        ...
        <div class="row2">
            ...
            <b><?php
			 echo $msg;
			?><br /><a href="list-job-requirements.php?<?php echo $s->value('URL_PARA')?>">Click here</a> to go back.</b>
            <div class="clear"></div>
          </div>
        <?php
		}
		?>
         ...
         <form method="post" enctype="multipart/form-data">
          ...
          <div class="row ">
            ...
            <img src="images/accept.gif"  width="109" height="36" class="space_lc4"  border="0" onclick="javascript:window.location='?jid=<?php echo $_REQUEST['jid']?>&cid=<?php echo $_REQUEST['cid']?>&accept=yes'" />
            &nbsp;&nbsp;&nbsp;&nbsp;
