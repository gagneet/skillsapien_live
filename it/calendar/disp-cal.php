...
if(isset($_GET['year']) && isset($_GET['month'])  && $_GET['month']=='All'){
					...
					echo "<tr><td  style='text-align:left;'><input type='button' onclick='privew(".$yearpre.")' value='Previous'></td><td  style='text-align:center;font-size:14px; font-weight:bold; color:green;'> ".$year."</td><td style='text-align:right;'><input type='button' onclick='privew(".$yearnext.")' value='Next'></td></tr>";
					for($ti=0;$ti<12;$ti++) {
							  $month = $ti+1;
							  if($ti%3==0) echo "<tr>";
								echo "<td valign='top'>";
							echo "<span class='monthnames'><b>".date( 'F', mktime(0, 0, 0, $month,1,0) )."</b></span>";
									  echo "<table border=0 class='tab' width='350px;'>";
											  ...
											  $candidatescount =noofcandidates($dateargument);
											  //$candidatescount =30;
...
elseif(isset($_GET['month'])){   
	...
	echo "<tr><td align='right' width='50px;'><input type='button' onclick='monthprev(".$year.",".$premonth.",0)' value='Previous'></td><td  style='text-align:center;'> ".date( 'F', mktime(0, 0, 0, $month,1,$year) )."-".$year."</td><td style='text-align:right;'><input type='button' onclick='monthprev(".$year.",".$nextmonth.",1)' value='Next'></td></tr>";
...
elseif(isset($_GET['day'])){
	...
	echo "<table cellspacing=10 border=0>";
	echo "<tr><td align='right'><input type='button' onclick='dayprev(".$preday.")'  value='Previous'></td><td  style='text-align:center;'> ".date('j M Y', $day)."</td><td style='text-align:left;'><input type='button' onclick='dayprev(".$nextday.")'  value='Next'></td></tr>";
echo "</table>";
	echo '<a href="allcandidates.php?date='.$dateargument.'" rel="facebox" style="text-decoration:none;">';
...
echo "<div class='daystyle'>";	
	...
	echo "<div class='daynames'>";
			echo "<b>".date("l", $day)."</b>";
			echo '</div><div style="background-color:'.$bgcolor.'; width: 90px; height: 75px; font-size: 35px;">';
...
elseif(isset($_GET['week'])){
	...
	echo "<table cellspacing=10 border=0>";
echo "<tr><td align='right'><input type='button' onclick='weekprev(".$preweek.")'  value='Previous'></td><td  style='text-align:center;'> ".date('M Y', $day)."</td><td style='text-align:left;'><input type='button' onclick='weekprev(".$nextweek.")'  value='Next'></td></tr>";
echo "</table>";
