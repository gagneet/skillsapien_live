	 ...
	 ?> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  //===============================================
  		  ...
  		  $post_run=$db->query_silent("SELECT sp.*,p.first_name,p.last_name,a.date as applied_date FROM 
          ...
          <tr <?php echo $class?>>
			...
			{?> <a href="counter-offer-acceptskill-profiles.php?jid=<?php echo $_REQUEST['jid']?>&cid=<?php echo $data['user_id']?>"  >Counter offer</a>
            <?php 
			}
			else
			{
