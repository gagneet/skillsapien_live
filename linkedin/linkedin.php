...
class LinkedIn {
  ...
  function search($parameters) {
    $search_url = $this->base_url . "/v1/people-search:(people:(id,first-name,last-name,picture-url,site-standard-profile-request,headline,main-address,summary,date-of-birth),num-results)" . $parameters;
