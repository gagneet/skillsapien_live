     ...
     if($s->value('USER_LOGIN')=="true")
	 {
	   switch(trim($s->value('USER_TYPE')))
	   {
		...
		?>
		 ...
		 {?> <li><img src="images/menu_line.gif" alt="" /></li><li><a href="#"> Find Skill </a></li>
         
		 <?php }
		 ?> <li><img src="images/menu_line.gif" alt="" /></li>
          <li><a href="#">Jobs by Skill </a></li>
          <li><img src="images/menu_line.gif" alt="" /></li>
          <li><a href="<?php echo  $general_browsing?>"> General Browsing </a></li>
          ...
          <li><img src="images/menu_line.gif" alt="" /></li>
           <li><a href="list-job-requirements.php">Post Job</a></li>
           <li><img src="images/menu_line.gif" alt="" /></li>
           <?php
		   }
          ...
          <li><img src="images/menu_line.gif" alt="" /></li>
           <li><a href="candidate-job-list.php">Job List</a></li>
           <?php
		   }
		   ?><li><img src="images/menu_line.gif" alt="" /></li>
