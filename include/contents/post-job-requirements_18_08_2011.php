...
<?		  ///********************************************************************************************************************************************//////// ?>
          ...
          <div class="row ">
            <input  type="image"  src="images/submit_button.gif" class="space_lc4"  />  
            <a href="recruiters-dashboard.php">
			<img src="images/cancel1btn.jpg" style="background:#79a72f; -moz-border-radius:3px; -webkit-border-radius:3px; border-radius:3px;" />
