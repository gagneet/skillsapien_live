...
<?		  ///********************************************************************************************************************************************//////// ?>
          ...
          <div class="row2">
		   ...
		   <div class="row2">
            <label class="label_cl2"> Select Profession Name </label>
            <table  border="0" cellspacing="0" cellpadding="0">
						<tr>
		   ...
		   <div class="row2">
            ...
            <table  border="0" cellspacing="0" cellpadding="0">
						<tr>
						  <td width="70"><input type="text" name="skillset" id="skillset"></td>
                            <td>&nbsp;</td>
						</tr>
					  </table>
		   ...
		   <div class="row2">
            ...
            <table  border="0" cellspacing="0" cellpadding="0">
						<tr>
						  <td width="70"><input type="text" name="qualification" id="qualification"></td>
                            <td>&nbsp;</td>
						</tr>
					  </table>
