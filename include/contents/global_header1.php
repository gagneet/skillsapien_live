...
global $s;
 ?><div class="header-top">
    <div class="header">
     <!-- <div class="logo"><a href="index.php"><img src="images/logo.png" alt="" border="0" /><img src="images/sapien_logo.png" alt="" border="0" /></a></div>-->
       <!-- VJ Change: Updated to point to latest Skillsapien logo, as of 2012-01-29: latest logo file renamed to "sapien_logo.png" and placed in /images/ folder. -->
      <div class="logo"><a href="index.php"><img src="images/sapien_logo.png" alt="Skillsapien Logo" border="0" height="70px" /></a></div>
      <?php
        ...
        <li><img src="images/menu_line.gif" alt="" /></li><li><a href="skill.php">Browse  Skills </a></li>
         ...
         <!-- <li><img src="images/menu_line.gif" alt="" /></li>-->
		  ...
		  <li><a href="about-us.php">About Skillsapien </a></li>
           <li><img src="images/menu_line.gif" alt="" /></li>
		  <li><a href="beta-release.php"><span style=color:#FFAA00;font-weight:bold;font-size:150%;position:relative;left:260px">- Beta Release - </span></a></li>
