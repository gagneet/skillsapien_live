...
<?php }?>
     ...
     <?php 
	 $sel="select * from candidate_interview where recruiter_id='$user_id'";
	 ...
	 Candidate Name : <?php echo $usernames; ?> &nbsp;<span style="color:red;"><?php if($reply!=""){ echo "Reply"; }?></span><br />
          <a  class="all" href="interview_msg.php?user_id=<?php echo $user_ids; ?>&id=<?php echo $ids; ?>">View</a> | <a class="all" href="#">Delete</a> | <a class="all" href="reply_msg.php?user_id=<?php echo $user_ids; ?>&id=<?php echo $ids; ?>">Reply</a></p>
<div class="clear"></div>
          </div>
          <div class="employer-id">
         <p class="checkbox-enployer-text">
        Country: <?php echo $countries_names; ?>
           </p>
<div class="clear"></div>
          </div>
     ...
     <div class="clear"></div>
      ...
      <div class="select-all-main">
         ...
         <div class="clear"></div>
           ...
           <?php 
		   $sel1="select * from recruiter_interview where candidate_id='$user_id'";
		  ...
		  while($row1=mysql_fetch_array($result1))
		  {
		   ...
		   $countries_names1=$row1['countries_name'];
		   $dates1=$row1['date'];
		     $reply=$row1['option'];
		  ?>
          ...
          <div class="employer-id"><p class="checkbox-enployer"> <input name="answers[]"  type="checkbox" value=""  class="checkbox-enployer"/></p>
         <p class="checkbox-enployer-text">
	 Recruiter Name : <?php echo $usernames1; ?> &nbsp;<span style="color:red;"><?php if($reply!=""){ echo "Reply"; }?></span><br />
          <a  class="all" href="interview_msg.php?user_id=<?php echo $user_ids1; ?>&id=<?php echo $ids1; ?>">View</a> | <a class="all" href="#">Delete</a> | <a class="all" href="reply_msg.php?user_id=<?php echo $user_ids1; ?>&id=<?php echo $ids1; ?>">Reply</a></p>
<div class="clear"></div>
          </div>
          <div class="employer-id">
         <p class="checkbox-enployer-text">
        Country: <?php echo $countries_names1; ?>
           </p>
<div class="clear"></div>
          </div>
