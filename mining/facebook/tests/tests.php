...
class PHPSDKTestCase extends PHPUnit_Framework_TestCase {
  const APP_ID = '165799493491742'; //'117743971608120';
  const SECRET = '66b417a1d9af60926d84d084d0b2f4bd'; //'943716006e74d9b9283d4d5d8ab93204';
  ...
  public function testGetCurrentURL() {
    ...
    $current_url = $facebook->publicGetCurrentUrl();
    $this->assertEquals(
      'http://www.vootar.com/unit-tests.php?one=&two=&three=',
      $current_url,
      'getCurrentUrl function is changing the current URL');
  ...
  public function testGetLoginURL() {
    ...
    $expected_login_params =
      array('client_id' => self::APP_ID,
            'redirect_uri' => 'http://www.vootar.com/unit-tests.php');
