...
function ValidateDate(job_start_d,job_end_d,job_start_m,job_end_m,job_start_y,job_end_y)
    {
...
function Validatemonth(job_start_m,job_end_m,job_start_y,job_end_y)
    {
...
$selbid=mysql_query("select net_bidcost,expence_bidcost from profiles where user_id='$user_id' and `vertical_id`='".VERTICAL_ID."'");
...
$skill_title="select * from skills_profiles where user_id='".$jobid."' and `vertical_id`='".VERTICAL_ID."'";
$skill_query=mysql_query($skill_title);
$skillrows=mysql_fetch_array($skill_query);
$title_skill=$skillrows['skills_profile'];

$selprofile1=mysql_query("select * from profiles where user_id='$user_id' and `vertical_id`='".VERTICAL_ID."'");
$rowprofile1=mysql_fetch_array($selprofile1);
 $senderemail=$rowprofile1['primary_email'];


$selprofile=mysql_query("select * from profiles where user_id='$jpid' and `vertical_id`='".VERTICAL_ID."'");
...
$seljob=mysql_query("select * from post_job where id='$jobid' and `vertical_id`='".VERTICAL_ID."'");
...
$selpro=mysql_query("select * from profession where id='$proid' and `vertical_id`='".VERTICAL_ID."'");
...
<div id="men">
        ...
        <div class="text-area"><?php echo $title_skill ; ?></div>
          ...
          <div class="row2">
            ...
            <table  border="0" cellspacing="0" cellpadding="0">
						<tr>
						  <td width="70">
                          <select name="job_start_d" id="job_start_d"   class="input5" onchange="ValidateDate('job_start_d','job_end_d','job_start_m','job_end_m','job_start_y','job_end_y');">
						  ...
						  <select name="job_start_m" id="job_start_m"   class="input4" onchange="Validatemonth('job_start_m','job_end_m','job_start_y','job_end_y');">
          ...
          <div class="row2">
            ...
            <table  border="0" cellspacing="0" cellpadding="0">
						<tr>
						  <td width="70"><select name="job_end_d" id="job_end_d"   class="input5"  onchange="ValidateDate('job_start_d','job_end_d','job_start_m','job_end_m','job_start_y','job_end_y');">
							  <option selected="selected" value="">-Date-</option>
							 <?php
							 for($d=1;$d<=31;$d++)
							 {
						  ...
						  <td width="80" align="center" valign="middle"><select name="job_end_m" id="job_end_m"   class="input4"  onchange="Validatemonth('job_start_m','job_end_m','job_start_y','job_end_y');">
                            <option value="" selected>-Month-</option>
                            <?php
							  $month=array("January","February","March","April","May","June","July","August","September","October","November","December");
							 for($d=0;$d<count($month);$d++)
  ...
  <div class="row2">
            ...
            <option value="" selected="selected">Select My Posted Job</option>
               <?php  $postedjob="select * from post_job where user_id='$jpid' and `vertical_id`='".VERTICAL_ID."'";
