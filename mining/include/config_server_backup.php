...
/* Database Host Name */ 
  ...
  define('host','n7-mysql5-3.ilisys.com.au');
/* Database Username */ 
    
 //define('username','root');
define('username','skillfg');
  
 
// define('password','');
define('password','sapien2011');
...
define('SITE_PATH', 'http://skillsapien.com/'); ## web content html and relatted dynamic work folder path
...
/*
	SET EMAIL INFO
*/
define('LOGIN_USER_EMAIL', 'arvind@w3csolutions.com'); 
