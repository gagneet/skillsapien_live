		 ...
		 ?>
			<h1>Sign up</h1>
				...
				<!--	<td width="120" align="right" valign="middle" class="required" height="35">Or Sign-in with Profile</td>-->
					<td  valign="middle">
                   <!--<div class="accont-search"><a href="http://182.50.141.145/applications/skillsapien/facebook/test.php"><img src="images/facebook.png" /></a> <span>or </span><a href="http://182.50.141.145/applications/skillsapien/linkedin/auth.php"><img src="images/linkedin.png" /></a></div>-->
                   <!-- <div class="accont-search"><a href="http://182.50.141.145/applications/skillsapien/facebook/test.php"><img src="http://182.50.141.145/applications/skillsapien/facebook/facebook_button.gif" width="100" height="30"/></a></div>-->
                    <!--<div class="accont-search">
						<input type="password" name="c_password" id="c_password" class="input3" />
					  </div><div id="error6" class="error"   style="display:none">Please enter confirm password.</div>--></td>
				  </tr>
				  <tr>
					<td colspan="2" style="height:auto; width:100%">
                    ...
                    <td height="80" align="left" valign="middle"><input type="image" src="images/sign-up-btn.jpg"  width="140" height="39" border="0" ></td>
                      <td><img src="images/linked-in.png" /></td>
                    </tr>
                    <tr>
                    <td colspan="2px"><img src="images/divide.png" /></td>
                    </tr>
                    
                    <tr>
                    <td style="color:#0772a6; font-size:12px;"><br /><a href="../it/indexlogin.php"><img src="images/leftarrow.png" align="top"  /></a><b style="padding-top:15px; padding-left:5px;">Login</b></td>
                    
                 <div class="loginimg">  <td style="float:right; color:#0772a6; font-size:12px;"><br /><b style="padding-top:15px; padding-right:5px;">Sign Up</b>   <a href="../it/index.php"><img src="images/rightarrow.png" align="top" style="margin-right:50px;" /></a>   </td></div>
                    </tr>
