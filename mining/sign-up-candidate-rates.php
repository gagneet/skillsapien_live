...
<div id="men">
 ...
 onfocus="if(this.value=='password') this.value=''"  />
          ...
          <div class="button">
            <input name="" type="submit" value=""  class="input_btn" />
          </div>
          <div class="clear"></div>
        </div>
      </div>
    ...
    <div class="navi_bg">
      <div id="navibar">
        <ul>
          ...
          <li><a href="#"> Find Skill </a></li>
          <li><img src="images/menu_line.gif" alt="" /></li>
          <li><a href="#">Jobs by Skill </a></li>
          <li><img src="images/menu_line.gif" alt="" /></li>
          <li><a href="#"> General Browsing </a></li>
          <li><img src="images/menu_line.gif" alt="" /></li>
      ...
      <div class="sign_cl">
        ...
        <div class="form_area2">
          <div class="row2">
            ...
            <input name="input" type="text"   src="type" class="currency1" />
            <input name="" type="radio" value="" style="margin: 10px  4px 0px 5px;" />
            Per Day
            <input name="" type="radio" value="" style="margin: 10px 4px 0px 5px;" />
            Month
            <input name="" type="radio" value="" style="margin: 10px 4px 0px 5px;" />
          ...
          <div class="row2">
            ...
            <select name="" size="1" class="select_cl2">
            </select>
            <div class="clear"></div>
          </div>
          <div class="row2">
            <label class="label_cl2">Privacy options for :</label>
            <textarea name="input" class="textarea_cl2"></textarea>
            <div class="clear"></div>
          </div>
          <div class="row ">
