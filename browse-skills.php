...
<div id="men">
  ...
  <div class="canten">
    <div class="center_in">
      ...
      <?php
	  $select="SELECT * FROM skills_profiles WHERE status='enable'";
 ...
 $myserchQuery='';
 	 ...
 	 // $sql="SELECT p.photo,p.date,sp.skills_profile,sp.skill_keywords,sp.profile_summary,r.gt_currency,r.gt_amount,r.gt_time_period, uld.id,uld.type  FROM  profiles as p, skills_profiles as sp, rates as r, user_login_details as uld where uld.type='C' and uld.id=p.user_id and uld.id=sp.user_id and uld.id=r.user_id ".$myserchQuery."";
	    ...
	    $sql="SELECT p.photo,p.date,sp.skills_profile,sp.skill_keywords,sp.profile_summary,r.gt_currency,r.gt_amount,r.gt_time_period, r.date, uld.id,uld.type  FROM  profiles as p, skills_profiles as sp, rates as r, user_login_details as uld where uld.type='C' and uld.id=p.user_id and uld.id=sp.user_id and uld.id=r.user_id ".$myserchQuery." limit ".$_REQUEST['start'].",".$rec_inc;
   ...
   $selectVal1 = $_POST['skillcat'];
      ...
      $myserchQuery1='and (sp.'.$selectVal.' LIKE "'.'%'.trim($txtvalue).'%'.'" )';
		...
		$myserchQuery1='';
		 ...
		 $sql1="SELECT p.photo,p.date,sp.skills_profile,sp.skill_keywords,sp.profile_summary,r.gt_currency,r.gt_amount,r.gt_time_period, r.date, uld.id,uld.type  FROM  profiles as p, skills_profiles as sp, rates as r, user_login_details as uld where uld.type='C' and uld.id=p.user_id and uld.id=sp.user_id and uld.id=r.user_id ".$myserchQuery1."";
