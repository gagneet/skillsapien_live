 <?php 
   ...
   //set user status
		...
		$sel=mysql_query("select * from functional_area where id='$id'");
		...
		$func_area_name=$rowsel['func_area_name'];
...
$ins=mysql_query("update functional_area set profession_id='$proid',disc_id='$discname',role_id='$role' ,tech_id='$t_name',func_area_name='$fun_ar_name' where id='$hid'");
	...
	<?php require('include/right.section.php')?>
				...
				<td id="mainImg" valign="top" align="center" height="500">
					<div class="section-title" style="height: 32px;">
							...
							<div class="float-left" style="margin-right: 20px; height: 32px; line-height: 32px; vertical-align: middle;">Edit Functional Area </div>
							
							<div style="float:right"><a href="functionalarealist.php">Back</a></div>
				    ...
				    <table cellpadding="0" cellspacing="0" width="70%" border="0" bgcolor="def2fd" >
					 ...
					 ?>
                       ...
                       <tr>
                         ...
                         <td>
                           <input type="text" name="fun_ar_name" id="fun_ar_name" value="<? echo $func_area_name ; ?> ">
                        </td>
                       </tr>
                      <tr>
                        <td>&nbsp;</td>
