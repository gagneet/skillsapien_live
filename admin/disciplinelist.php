	...
	<?php require('include/right.section.php')?>
				...
				<td id="mainImg" valign="top" align="center" height="500">
					<div class="section-title" style="height: 32px;">
							...
							<div class="float-left" style="margin-right: 20px; height: 32px; line-height: 32px; vertical-align: middle;"> List of Discipline:</div>
							<div style="float:right"><a href="adddisciplinelist.php">Add New</a></div>
				    ...
				    <table cellpadding="0" cellspacing="0" width="100%" border="0" bgcolor="def2fd" >
					  ...
					  $sel=mysql_query("select profession.name,disciplinelist.disc_name,disciplinelist.id from profession,disciplinelist 
where profession.id=disciplinelist.profession_id limit ".$_REQUEST['start'].", ".$rec_inc);
					  $i=1;
                      ...
                      <tr>
                        ...
                        <td><a href="editdisc.php?id=<? echo $row['id'] ; ?>">Edit</a>&nbsp;&nbsp;<a  onClick="return confirm('Do You want to Delete this record.\n\ Proceed to delete  Click on OK   ');" href="delindus.php?id=<? echo $row['id'] ; ?>&page=disclist"><font color="#CC0000">Delete</font></a></td>
                      </tr>
					  <?
					  $i++; 
					  }
