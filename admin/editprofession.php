 <?php 
   ...
   //set user status
 		  $id=$_REQUEST['id'];
		  	...
		  	$selpro=mysql_query("select * from profession where id='$id'");
...
$ins=mysql_query("update  profession set name='$name' where id='$hid'");
$ms="Data have sucessfully saved";		
header("location:professionlist.php?ms=$ms");
		}
	...
	<?php require('include/right.section.php')?>
				...
				<td id="mainImg" valign="top" align="center" height="500">
					<div class="section-title" style="height: 32px;">
							...
							<div class="float-left" style="margin-right: 20px; height: 32px; line-height: 32px; vertical-align: middle;"> Add New Profession:</div>
							<div style="float:right"><a href="professionlist.php">Back</a></div>
				  ...
				  <form name="frm1" id="frm1" action="" method="post">
				    <table cellpadding="0" cellspacing="0" width="70%" border="0" bgcolor="def2fd" >
                      ...
                      <tr>
                        <td>Enter Profession Name </td>
                        <td><input type="text" name="indus_name" width="250px;" value="<? echo $rowselpro['name'] ;  ?>">
