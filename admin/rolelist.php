	...
	<?php require('include/right.section.php')?>
				...
				<td id="mainImg" valign="top" align="center" height="500">
					<div class="section-title" style="height: 32px;">
							...
							<div class="float-left" style="margin-right: 20px; height: 32px; line-height: 32px; vertical-align: middle;"> List of Role </div>
							<div style="float:right"><a href="addrole.php">Add New</a></div>
				    ...
				    <table cellpadding="0" cellspacing="0" width="100%" border="0" bgcolor="def2fd" >
                      <tr>
                        <td colspan="5">&nbsp;<? echo $_REQUEST['ms'];  ?></td>
                      </tr>
                      <tr>
                        <td>Sr.no</td>
					  ...
					  $sel=mysql_query("SELECT profession.name, disciplinelist.disc_name,role.role,role.id
FROM profession, disciplinelist, role
WHERE profession.id = role.profession_id
AND disciplinelist.id = role.disc_id limit ".$_REQUEST['start'].", ".$rec_inc);
					  $i=1;
