    ...
    <tbody>
      ...
      <tr>
        ...
        <td id="mainImg" valign="top" align="center" height="500"><div class="section-title" style="height: 32px;">
            <div class="float-left" style="margin-right: 20px; height: 32px; line-height: 32px; vertical-align: middle;"> List of Skillset </div>
          <div style="float:right"><a href="addskillset.php">Add New</a></div>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" border="0" bgcolor="def2fd" >
                  ...
                  <tr>
                    ...
                    <td width="14%"><strong>Functional Area</strong> </td>
                     <td width="14%"><strong>Skillset</strong> </td>
